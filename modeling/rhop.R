...
rhop = function(t=0:1000/500, rhoc0=10, rhon0=1, nu=10, rhop0=1, etap=2, gammap=3, turnOff=0) {
    ...
    if (nu==gammap) {
        ...
        f = rhop0 - etap*rhoc0*t*exp(-nu*t) + etap*rhoc0/nu - etap*rhoc0*exp(-nu*t)/nu
    ...
    if (turnOff>0) {
        ...
        rhopTurnOff = rhop(t=turnOff,rhoc0=rhoc0,rhon0=rhon0,nu=nu,rhop0=rhop0,etap=etap,gammap=gammap,turnOff=0)

        f[t>turnOff] = rhop0 + (rhopTurnOff-rhop0)*exp(-gammap*(t[t>turnOff]-turnOff))

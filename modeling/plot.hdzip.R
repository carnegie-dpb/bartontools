...
plot.hdzip = function() {
  ...
  tData = getTimes(schema="bl2012",condition="GR-REV")/60

  hat1 = getExpression(schema="bl2012",condition="GR-REV", gene="HAT1")
  hat2 = getExpression(schema="bl2012",condition="GR-REV", gene="HAT2")
  hat3 = getExpression(schema="bl2012",condition="GR-REV", gene="HAT3")
  hat9 = getExpression(schema="bl2012",condition="GR-REV", gene="HAT9")
  hat22 = getExpression(schema="bl2012",condition="GR-REV", gene="HAT22")
  hb2 = getExpression(schema="bl2012",condition="GR-REV", gene="HB-2")
  ...
  hat22.fit= rhop(t=t, turnOff=0.5, nu=nu,rhoc0=rhoc0,gamman=gamman, rhop0=182.2, etap=91.5, gammap=4.11)
  hb2.fit  = rhop(t=t, turnOff=0.5, nu=nu,rhoc0=rhoc0,gamman=gamman, rhop0=138.4, etap=57.4, gammap=2.04)
  ...
  lines(t, hb2.fit/hb2.base, lty=4)
  ...
  plot.bars(tData, hb2/hb2.base, over=T, pch=23)
  ...
  legend(2, 5, xjust=1, yjust=1, lty=1:6, pch=c(8,21:25),
         c(
           ...
           expression(paste(italic("HB-2"), "   ",gamma[p],"=2.04",h^-1,"  ",r^2,"=0.90")),

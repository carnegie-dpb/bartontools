...
ylim = c(10,250)
plot.AHP4(schema="bl2012",condition="GR-REV", ylim=ylim)
text(-0.04, 0.92*ylim[2], pos=4, "(a) microarray: GR-REV")

ylim = c(0.5,100)
plot.AHP4(schema="bl2013",condition="GR-REV", ylim=ylim)
text(-0.04, 0.90*ylim[2], pos=4, "(b) RNA-seq: GR-REV")


ylim = c(1.8,20)
plot.AHP4(schema="bl2013",condition="GR-STM", ylim=ylim)

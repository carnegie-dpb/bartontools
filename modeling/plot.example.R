...
text(1.0, 14.2, bquote(rho[p]), pos=2, col="darkgreen", cex=1.5)
text(1.4, 10.5, bquote(rho[s]), pos=2, col="red", cex=1.5)
...
text(1.6, ytop-2, bquote(rho[p0]==.(round(rhop0,1))), pos=4, col="darkgreen", cex=1.0)
text(1.6, ytop-3, bquote(rho[s0]==.(round(rhos0,1))), pos=4, col="red", cex=1.0)

ytop = 8
text(1.6, ytop, bquote(paste(nu==.(round(nu,1))," ",h^-1)), pos=4, col="blue", cex=1.0)
text(1.6, ytop-2, bquote(paste(eta[p]==.(round(etap,1))," ",h^-1)), pos=4, col="darkgreen", cex=1.0)
text(1.6, ytop-3, bquote(paste(gamma[p]==.(round(gammap,1))," ",h^-1)), pos=4, col="darkgreen", cex=1.0)
text(1.6, ytop-5, bquote(paste(eta[s]==.(round(etas,1))," ",h^-1)), pos=4, col="red", cex=1.0)
text(1.6, ytop-6, bquote(paste(gamma[s]==.(round(gammas,1))," ",h^-1)), pos=4, col="red", cex=1.0)

...
transmodel2.num.error = function(p, fitType, turnOff, rhoc0,rhon0,nu,gamman, rhop0,etap,gammap, rhos0,etas,gammas, dataTimes, dataValues) {
  ...
  ## solve rhos
  rhos = rhos.num(turnOff=turnOff, rhoc0=rhoc0,rhon0=rhon0,nu=nu,gamman=gamman, rhop0=rhop0,etap=etap,gammap=gammap, rhos0=rhos0,etas=etas,gammas=gammas, t=t)

...
public class CuffdiffResult extends AnalysisResult {
    ...
    /**
     * Placeholder constructor until I update this class to be consistent with CuffdiffTimeResult
     */
    public CuffdiffResult(ServletContext context, Experiment experiment, String condition, Gene gene) throws SQLException, FileNotFoundException, NamingException, ClassNotFoundException {

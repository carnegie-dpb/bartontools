...
public class User implements Comparable {
	...
	try {
	    ...
	    List<CharacterRule> rules = Arrays.asList(
						      new CharacterRule(EnglishCharacterData.Alphabetical, 12),  // at least twelve alpha characters
						      new CharacterRule(EnglishCharacterData.Digit, 12)          // at least eight digit characters
						      );

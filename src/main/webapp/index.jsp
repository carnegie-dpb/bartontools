...
<html>
  ...
  <body>
    ...
    <table class="experimentIndex" cellspacing="0">
	 ...
	 <tr>
	   <td class="schema"><a href="<%=publicExperiments[i].schema%>/index.jsp"><%=publicExperiments[i].schema.toUpperCase()%></a></td>
    ...
    <% if (user.isDefault()) { %>
    <h2><a href="login.jsp">Log in</a> to view non-public experiments shared with you. <a href="register.jsp">Register</a> to create an account.</h2>
    <% } else { %>
    ...
    <table class="experimentIndex" cellspacing="0">
	 ...
	 <tr>
	   <td class="schema"><a href="<%=privateExperiments[i].schema%>/index.jsp"><%=privateExperiments[i].schema.toUpperCase()%></a></td>

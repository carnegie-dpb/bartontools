...
public class TAIRGene extends Gene {
	 ...
	 */
	public static Gene[] searchOnComputationalDescription(ServletContext context, Experiment experiment, String searchterm) throws SQLException, FileNotFoundException, NamingException, ClassNotFoundException, UnsupportedEncodingException {
		DB db1 = null;
		DB db2 = null;
		try {
			...
			while (db1.rs.next()) set.add(new Gene(db2, db1.rs.getString("id")));
